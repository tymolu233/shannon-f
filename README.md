...
When using the OpenAI router provider, you can optionally override the default endpoint with an OpenAI-compatible Chat Completions URL.
...
# Optional for OpenAI router provider: override the Chat Completions endpoint
export OPENAI_BASE_URL=https://your-proxy.example.com/v1/chat/completions
```
...
```bash
OPENAI_API_KEY=sk-...
OPENAI_BASE_URL=https://your-proxy.example.com/v1/chat/completions
# OR
